...
const WeddingComponent = () => {
  ...
  return (
    <>
      <div className="w-full bg-[#FDF3D8] pt-5 sm:pt-[38px] pb-5 sm:pb-[60px] mt-10 sm:mt-[72px]">
        <div className="container px-4 sm:px-20 flex flex-col gap-5 sm:flex-row justify-between">
          <div className="w-full sm:w-[622px] pt-[32px] sm:pt-[64px] px-5 sm:px-10 pb-[30px] sm:pb-[90px] flex flex-col bg-white space-y-4 sm:space-y-8 rounded-2xl">
            <h1 className="text-[28px] sm:text-[56px] font-bold text-[#212529] sm:leading-[64px] text-center  text-left uppercase">
              Treepz for Weddings
            </h1>
            <div className="flex space-y-8 flex-col font-normal text-center sm:text-left text-lg sm:text-xl text-[#212529]">
              <p>
                Weddings are tough to plan. Finding wedding <br className="hidden sm:block" />{" "}
                transportation shouldn’t be.
              </p>
              <p>Book Treepz for a seemless wedding transportation.</p>
            </div>
            <Button
              variant={"default"}
              className="relative w-full sm:w-[151px] sm:h-[64px] group overflow-hidden mt-8 sm:mt-[60px]"
              onClick={showModal}
            >
      ...
      <WeddingFeatures />
      <div className=" mt-[40px] sm:mt-[150px]"></div>
      <Testimony />
      ...
      <div className="w-full my-[70px] py-[48px] sm:py-[73px] bg-[url(/wedding-bg.png)] bg-cover bg-no-repeat h-fit px-4 sm:px-0">
        <div className="w-full mx-auto text-white">
          <h1 className="text-[28px] sm:text-[56px] font-semibold leading-[40px] sm:leading-[64px] text-center mb-2">
            Inquire about Treepz Wedding Transportation
          </h1>
          ...
          <Button
            variant={"default"}
            className="relative w-full sm:w-[151px] sm:h-[64px] group overflow-hidden sm:mt-10 sm:mb-[48px] mx-auto flex justify-center"
